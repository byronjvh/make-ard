...
export const translations = {
    en: {
        ...
        description: "Create cards with your model's data in seconds, choose a theme, and share them wherever you want. 3D Print Card Generator.",
    ...
    es: {
        ...
        description: "Genera cards con los datos de tu modelo en segundos, elige un theme y compártelas donde quieras. Generador de tarjetas para impresión 3D.",
